      ...
      <Dropdowncontainer>
        ...
        {drop && (
          <Dropdownlistcontainer>
            <Dropdownlist>
              <Listitem>
                <img src={logo1} alt="img" /> Export as Image
              </Listitem>
              <Listitem>
                <img src={logo2} alt="pdf" /> Export as a PDF
              </Listitem>
              <Listitem>
                <img src={logo3} alt="website" /> Embed in Website
              </Listitem>
              <Listitem>
                <img src={logo4} alt="cloud" /> Save to Zuri Cloud
              </Listitem>
            </Dropdownlist>
          </Dropdownlistcontainer>
        )}
